                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item"><a href="{{ route('userGente') }}" class="nav-link">Explorar</a>
                            <li class="nav-item"><a href="{{ route('likes') }}" class="nav-link">Favoritas</a></li>
                            <li class="nav-item"><a href="{{ route('imageCreate') }}" class="nav-link">Subir Imagen</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item"
                                        href="{{ route('usuarioPerfil', ['id' => Auth::user()->id]) }}">Mi perfil</a>
